...
def inputPlayerLetter():
    ...
    # the first element in the list is the player's letter, the second is the computers letter.
    if letter == 'X':
        return ['X', 'O']
    else:
        return ['O', 'X']
...
def isWinner(bo, le):
    ...
    # We use bo instead of board and le instead of letter wo we don't have to type as much.
...
def getPlayerMove(board):
    # Let the player tpe in their move.
    move = ' '
